...
const CardItem: types.Brick<CardItemProps> = ({
  screenLayout,
  isTextCenter = false,
...
CardItem.schema = {
  name: blockNames.CardItem,
  label: 'Card',
  category: 'rb-ui website',
  hideFromAddMenu: true,
  playgroundLinkLabel: 'View source code on Github',
  playgroundLinkUrl:
    'https://github.com/ReactBricks/react-bricks-ui/blob/master/src/website/Cards/CardItem.tsx',
